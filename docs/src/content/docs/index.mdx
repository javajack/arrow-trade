...
<Aside type="note" title="New: Arrow Elite (docs2)">
A separate, reimagined goal now lives alongside this plan: **[Arrow Elite — Algo Cloud](/elite/)**, a premium big-ticket tier that productizes iRage's institutional algo capability as a broker-hosted strategy catalogue for HNI/UHNI and high-frequency traders (NSE/BSE/MCX only). It has its own sub-context; start at the [Elite overview](/elite/).
</Aside>
...
<CardGrid>
  ...
  <Card title="Viability & Hard Questions" icon="random">
    The supply-side stress test: [economics & the LTV paradox](/viability/economics-ltv-paradox/) (the wedge is people who lose money and quit — why the model works anyway), [the HFT parent's edge and its limits](/viability/hft-edge-and-limits/), [the trust cold-start](/viability/trust-cold-start/), an honest [pre-mortem](/viability/pre-mortem/) including the broker × HFT-prop conflict of interest, and [AI without advice](/viability/ai-without-advice/).
  </Card>
