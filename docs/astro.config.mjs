  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: '★ Arrow Elite — Algo Cloud (docs2)',
          items: [
            { label: 'Overview', slug: 'elite' },
            { label: 'The Elite Thesis & Positioning', slug: 'elite/the-thesis' },
            { label: 'The Big-Ticket Segment', slug: 'elite/big-ticket-segment' },
            { label: 'Arrow Algo Cloud — The Product', slug: 'elite/algo-cloud' },
            { label: 'Regulatory & Trust Architecture', slug: 'elite/regulatory-and-trust' },
            { label: 'Finding the Whales — GTM', slug: 'elite/finding-the-whales' },
            { label: 'Pricing, Economics & Moat', slug: 'elite/pricing-and-economics' },
            { label: 'Pre-Mortem (Elite)', slug: 'elite/pre-mortem' },
          ],
        },
      ],
    }),
